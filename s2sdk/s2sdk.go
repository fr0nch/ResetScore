...
type CvarValueCallback func(playerSlot int32, cookie int32, code CvarValueStatus, name string, value string, data []interface{})
...
type TimerCallback func(timer uint32, userData []interface{})
